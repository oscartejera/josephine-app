/**
 * useLabourDataNew - Hook for Labour page using optimized RPC calls
...
interface UseLabourDataNewParams {
  dateRange: LabourDateRange;
  locationId?: string | null;
}

export function useLabourDataNew({ dateRange, locationId }: UseLabourDataNewParams) {
