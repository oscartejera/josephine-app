/**
 * LabourHeaderNew - Nory-style header with breadcrumbs, date picker, toggles
 */
...
import type { LabourDateRange, MetricMode } from '@/hooks/useLabourDataNew';

interface LabourHeaderNewProps {
...
export function LabourHeaderNew({
  dateRange,
  setDateRange,
  metricMode,
  setMetricMode,
