...
/** Server version — injected at startup by each adapter. */
let _serverVersion = "0.1.0";
export function setServerVersion(v: string) { _serverVersion = v; }
export function getServerVersion(): string { return _serverVersion; }
