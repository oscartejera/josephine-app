...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // This avoids mismatch errors when the app is accessed from different domains.
    const authUrl = `${baseUrl}?client_id=${clientId}&scope=${scopes}&session=false&state=${state}`;
